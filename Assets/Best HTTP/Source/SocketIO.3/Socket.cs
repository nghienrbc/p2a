...
namespace BestHTTP.SocketIO3
{
    ...
    public sealed class Socket : ISocket
    {
        ...
        public void On<T1, T2, T3, T4, T5>(string eventName, Action<T1, T2, T3, T4> callback)
        {
            this.TypedEventTable.Register(eventName, new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, (args) => callback((T1)args[0], (T2)args[1], (T3)args[2], (T4)args[3]));
        }
        ...
        public void Once<T1, T2, T3, T4, T5>(string eventName, Action<T1, T2, T3, T4> callback)
        {
            this.TypedEventTable.Register(eventName, new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, (args) => callback((T1)args[0], (T2)args[1], (T3)args[2], (T4)args[3]), true);
        }
